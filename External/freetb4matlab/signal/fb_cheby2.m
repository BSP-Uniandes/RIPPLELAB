...
function [a,b,c,d] = fb_cheby2(n, Rs, W, varargin)

  if (nargin>5 || nargin<3) || (nargout>4 || nargout<2)
    error ('[b, a] or [z, p, g] or [a,b,c,d]= cheby2 (n, Rs, W, [, ''ftype''][,''s''])');
  end
  ...
  [zero, pole, gain] = fb_sftrans(zero, pole, gain, W, stop);

  %# Use bilinear transform to convert poles to the z plane
  if digital
    [zero, pole, gain] = fb_bilinear(zero, pole, gain, T);
  end
