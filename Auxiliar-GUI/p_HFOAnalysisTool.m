...
% Labels Building
%..........................................................................
st_hAxes.SigLabelAx = axes('Parent',st_hPanel.Axes,... 
                    'Position',[.025 .76 .85 .5],...
                    'Visible','off');

st_hAxes.SigLabText = text('Parent',st_hAxes.SigLabelAx,... 
                    'String','Original Interval',...
                    'FontSize',st_Letter.toolcontrol,...
                    'Rotation',90); 
                
st_hAxes.FilLabelAx = axes('Parent',st_hPanel.Axes,... 
                    'Position',[.025 .45 .85 .5],...
                    'Visible','off');

st_hAxes.FilLabText = text('Parent',st_hAxes.FilLabelAx,... 
                    'FontSize',st_Letter.toolcontrol,...
                    'String','Filtered Interval',...
                    'Rotation',90);  
...
st_Event.EvType          = uicontrol(st_hPanel.Event,...
                        ...
                        'ForegroundColor',v_TextColor,...      
                        'FontSize',.7*st_Letter.toolcontrol,...
                        'String','None|Gamma|Ripple|FastRipple|Spike|Artifact|Other',...
                        'Units','normalized',...
                        'Position',[.53 .15 .2 .2],...
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_SaveInterval(h_Object,~)
        ...
        v_SigInterval   = st_SigData.v_Signal(...
                        st_EvControl.s_PosIni:st_EvControl.s_PosEnd); %#ok<NASGU>
                            
        s_FreqSample    = st_ElecData.st_HFOInfo.s_Sampling;  %#ok<NASGU>
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_ControlSetEventInfo()
        ...
        set(st_Event.EvMaxFreq,...
            'String',sprintf('%2.2f Hz',st_EvInfo.s_EvMaxFreq))        
        set(st_Event.EvDuration,...
            'String',sprintf('%2.2f mS',st_EvInfo.s_EvenTime))
