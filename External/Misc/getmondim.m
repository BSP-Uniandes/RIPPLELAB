...
%   modified 03/04/2008 MIH to include warning identifier on Matlab Ver. 7.5
...
% end bugfix
    ...
    warning('FigManagement:DisplayMonitorNotExist','Monitor %s does not exist!',num2str(mnum));   %#ok
    y=[];
end
