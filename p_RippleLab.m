...
% 
%   The sections to modify when a new method is included are marked with a [**INSERT!**]
%   comment
% 
% 
%   Written by:
...
st_ElecInfo          = struct;
%     st_ElecInfo.str_DispName   = []; % Channel's Display Name
    
    st_ElecInfo.str_ElecName    = []; % Channel's Name   
    st_ElecInfo.str_ElecLoad    = []; % Channel's Name     
    st_ElecInfo.str_Montage     = []; % Channel's Source File
    st_ElecInfo.str_MtgeLoad    = []; % Channel's Source File
    st_ElecInfo.s_Sampling      = []; % Channel's FreqSampling
    st_ElecInfo.s_TotalTime     = []; % Channel's Source File
    
    st_ElecInfo.str_MemoFile    = []; % Channel's Memory File
    st_ElecInfo.str_CommonElec  = []; % Channel's Source File
    st_ElecInfo.str_CommMont    = []; % Channel Montage 
    st_ElecInfo.st_FileInfo     = []; %
    st_ElecInfo.st_FileIdxLoad  = []; %
%     st_ElecInfo.str_TmpPath   = './Temp/'; %
...
st_Spectrum.st_FilterData.v_NewElecIdx    = [];
...
st_FilterData.m_ElecFilter      = [];
st_FilterData.v_ElecIdx         = [];
st_FilterData.v_FiltCutFr       = [];
st_FilterData.v_NewElecIdx      = false;
...
st_Position       = struct;
    ...
    % st_Position.s_ElecSelected   = Number of signals selected
    % st_Position.s_NumElecSel     = Number of signals selected
    % st_Position.v_VerticalPos   = v(1) The First Pos, v(2) Channel Qty 
    % st_Position.s_FirstElecDispl   = First Signal Dispayed
...
st_Position.s_ElecSelected      = [];           
st_Position.s_NumElecSel        = 0;
st_Position.v_VerticalPos       = [];
st_Position.s_FirstElecDispl    = 1;
...
st_HFOData.str_ElectLabels  = [];
st_HFOData.v_ElecHFOInfo    = [];
st_HFOData.v_EvtInterv      = [];

st_HFOControl.IsVisualMrk       = 0;
st_HFOControl.s_CurrElecIdx     = [];
st_HFOControl.v_ElectrodeIdx    = [];
...
v_HFOMethodsList	= [{'Visual Marking'},{'Short Time Energy'},{'Short Line Length'}...
                    {'Hilbert Detector'},{'MNI Detector'},{'Modify for your new method'}];
                
% Example:

% v_HFOMethodsList	= [{'Visual Marking'},{'Short Time Energy'},{'Short Line Length'}...
%                     {'Hilbert Detector'},{'MNI Detector'},{'XXX Detector'}];
...
st_hFigure.SelElec      = figure(...
                        'WindowStyle','modal',...
                        'Resize','off',...
                        'IntegerHandle','off',...
                        'NumberTitle','off', ...
                        'Name','Select Electrodes', ...
                        'Color',v_FigColor,...
                        'Units','normalized',...
                        'Position',[.1 .3 .4 .5],...
                        'Visible','off',...
...
st_hFigure.MontageElec = figure(...   
                        'WindowStyle','modal',...
                        'Resize','off',...
                        'IntegerHandle','off',...
                        'NumberTitle','off', ...
                        'Name','Assembly Electrodes', ...
                        'Color',v_FigColor,...
                        'Units','normalized',...
                        'Position',[.15 .35 .15 .2],...
                        'Visible','off',...
...
st_hMenu.FileSave    = uimenu(st_hMenu.File,...
                    'Label','Save Electrodes',...
                    'Accelerator','S',...
                    'CallBack',@f_SaveElectrodes);
...
st_hIcons.save      = uitoggletool(st_hToolbar.Icons,...
                    'CData',st_Icons.save,...
                    'TooltipString','Save Electrodes',...
                    'ClickedCallback',@f_SaveElectrodes);     
...
st_Select.ElecLabel   = uicontrol(st_hToolbar.Select,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toollabel*.7,...
...
st_Select.ElecList    = uicontrol(st_hToolbar.Select,...
                        'Style','popupmenu',...
                        'BackgroundColor','w',...     
                        'FontSize',.8*st_Letter.toolcontrol,...
                        'String','1',...
...
st_Filter.ElecButt        = uicontrol(st_hToolPanel.Filter,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...     
                        'FontSize',.8*st_Letter.toolcontrol,...
                        'String','Select Ch',...
...
st_Filter.FiltRemoveButt  = uicontrol(st_hToolPanel.Filter,...
                        ...
                        'Units','normalized',...
                        'HorizontalAlignment','center',...  
                        'String','Remove Electrodes',...
                        'FontSize',st_Letter.toolcontrol*.8,...
                        'Position',[.895 0 .095 1],...
                        'CallBack',@f_FilterRemoveElectrode);              
...
st_TimeFreq.ElecLabel  = uicontrol(st_hToolPanel.TimeFreq,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toollabel*.7,...
...
st_TimeFreq.ElecList   = uicontrol(st_hToolPanel.TimeFreq,...
                        'Style','popupmenu',...
                        'BackgroundColor','w',...
                        'FontSize',.8*st_Letter.toolcontrol,...
                        'Units','normalized',...
...
st_SegmAnalys.LabElecName   = uicontrol(st_hToolPanel.Segment,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toollabel*.7,...
...
st_SegmAnalys.ElecList   = uicontrol(st_hToolPanel.Segment,...
                        'Style','popupmenu',...
                        'BackgroundColor','w',...     
                        'FontSize',.8*st_Letter.toolcontrol,...
                        'String',' ',...
...
st_MontageElec.MontageLab  = uicontrol(st_hFigure.MontageElec,...  
                        'Style','text',...                  
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','right',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.Montage    = uicontrol(st_hFigure.MontageElec,...
                        'Style','popupmenu',...
                        'BackgroundColor','w',...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.Elec1Lab       = uicontrol(st_hFigure.MontageElec,...  
                        'Style','text',...                  
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.Elec2Lab       = uicontrol(st_hFigure.MontageElec,...  
                        'Style','text',...                  
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.SelElec1     = uicontrol(st_hFigure.MontageElec,...
                        'Style','popupmenu',...
                        'BackgroundColor','w',...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.SelElec2     = uicontrol(st_hFigure.MontageElec,...
                        'Style','popupmenu',...
                        'BackgroundColor','w',...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.ListElec2     = uicontrol(st_hFigure.MontageElec,...
                        'Style','listbox',...
                        'BackgroundColor','w',...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.OkButt       = uicontrol(st_hFigure.MontageElec,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.SaveButt	= uicontrol(st_hFigure.MontageElec,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_MontageElec.CancelButton = uicontrol(st_hFigure.MontageElec,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
% Info Panel -----------                
st_SelElect.ElectPanel	= uipanel(st_hFigure.SelElec,...
                        'BackgroundColor',v_FigColor,...
                        'Title','',...
                        'Position',[0 0.2 1 0.8],...
                        'BorderType','none');
  
st_SelElect.FileListLab = uicontrol(st_SelElect.ElectPanel,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.FileList    = uicontrol(st_SelElect.ElectPanel,...
                        'Style','popupmenu',...
                        'BackgroundColor','w',...
                        'HorizontalAlignment','right',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.AddFiles    = uicontrol(st_SelElect.ElectPanel,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.DeleteFiles = uicontrol(st_SelElect.ElectPanel,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.ElecListLab	= uicontrol(st_SelElect.ElectPanel,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.ElecList    = uicontrol(st_SelElect.ElectPanel,...
                        'Style','listbox',...
                        'BackgroundColor','w',...
                        'Units','normalized',...
                        'Max',10,...
...
st_SelElect.MontageButt	= uicontrol(st_SelElect.ElectPanel,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.SelElecLab	= uicontrol(st_SelElect.ElectPanel,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
                        'String','Selected Electrodes',...
                        'Units','normalized',...
                        'Position',[.32 .8 .3 .05]);
                    
st_SelElect.AddElec     = uicontrol(st_SelElect.ElectPanel,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
                        ...
                        'CallBack',@f_InfoElecAdd);    
                    
st_SelElect.RmvElec     = uicontrol(st_SelElect.ElectPanel,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
                        ...
                        'CallBack',@f_InfoElecRemove);  
                    
st_SelElect.UpElec      = uicontrol(st_SelElect.ElectPanel,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
                        ...
                        'CallBack',@f_InfoElecUp);       
                    
st_SelElect.DownElec	= uicontrol(st_SelElect.ElectPanel,...
                        'Style','pushbutton',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
                        ...
                        'CallBack',@f_InfoElecDown);                      
                    
% Individual signal info --------------------------------
                    
st_SelElect.InfoTable = uitable(st_SelElect.ElectPanel,...
                        'BackgroundColor',[1 1 1],...
                        'ColumnEditable',[],...
                        'ColumnName',{'Electrode','Sampling',...
                                        'Time(min)','Montage'},...
                        'RowName','numbered',...
                        'FontSize',st_Letter.toolcontrol,...
                        'Units','normalized',...
...
% Time Panel -----------                    
st_SelElect.TimePanel    = uipanel(st_hFigure.SelElec,...
                        'BackgroundColor',v_FigColor,...
                        'FontWeight','Bold',...
...
% Time Labels ----------  
st_SelElect.TimeLabIni   = uicontrol(st_SelElect.TimePanel,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.TimeLabEnd   = uicontrol(st_SelElect.TimePanel,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
% Time Texts -----------  
st_SelElect.TimeTxtIni   = uicontrol(st_SelElect.TimePanel,...
                        'Style','edit',...
                        'BackgroundColor','w',...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.TimeTxtEnd   = uicontrol(st_SelElect.TimePanel,...
                        'Style','edit',...
                        'BackgroundColor','w',...
                        'HorizontalAlignment','center',...      
                        'FontSize',st_Letter.toolcontrol,...
...
% Buttons --------------   
st_SelElect.DisplayButt    = uicontrol(st_hFigure.SelElec,...
                        'Style','pushbutton',...
                        'FontWeight','bold',...
                        'BackgroundColor',v_FigColor,...       
                        'FontSize',st_Letter.toolcontrol,...
                        ...
                        'Enable','On',...
                        'Position',[.55 .12 .2 .07],...
                        'CallBack',@f_ElectrodeDisplay);       
                    
st_SelElect.ClearButton    = uicontrol(st_hFigure.SelElec,...
                        'Style','pushbutton',...
                        'FontWeight','bold',...
                        'BackgroundColor',v_FigColor,...       
                        'FontSize',st_Letter.toolcontrol,...
...
st_SelElect.ApplyButton    = uicontrol(st_hFigure.SelElec,...
                        'Style','pushbutton',...
                        'FontWeight','bold',...
                        'BackgroundColor',v_FigColor,...       
                        'FontSize',st_Letter.toolcontrol,...
                        ...
                        'Enable','On',...
                        'Position',[.75 .12 .2 .07],...
                        'CallBack',@f_ElectrodeApply);
                    
st_SelElect.CancelButton = uicontrol(st_hFigure.SelElec,...
                        'Style','pushbutton',...
                        'FontWeight','bold',...
                        'BackgroundColor',v_FigColor,...       
                        'FontSize',st_Letter.toolcontrol,...
...
st_HFOMethod.ChannelLab = uicontrol(st_hFigure.HFOMethods,...
                        ...
                        'HorizontalAlignment','left',...      
                        'FontSize',st_Letter.toolcontrol,...
                        'String','Select Electrodes: ',...
                        'Units','normalized',...
                        'Position',[.05 .9 .3 .06]);

st_HFOMethod.ElectrodeList  = uicontrol(st_hFigure.HFOMethods,...
                        'Style','list',...
                        'BackgroundColor','w',...     
                        'FontSize',st_Letter.toolcontrol,...
                        'String','',...
...
st_HFOMethod.VIS_Message  = uicontrol(st_HFOMethod.VISPanel,...
                        ...
                        {' '};...
                        {'- Electrodes must been displayed'};....
...
st_VisualMark.ElectrodeLab     = uipanel(st_hToolbar.VisualMark,...
                        'BackgroundColor',v_FigColor,...
                        'HighlightColor',[.9 .9 .9],...
                        'Title','Electrode',...
                        'BorderType','line',...
...
st_VisualMark.Electrode     = uicontrol(st_VisualMark.ElectrodeLab,...
                        'Style','text',...
                        'BackgroundColor',v_FigColor,...
                        'ForegroundColor','b',...
                        'HorizontalAlignment','center',...      
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_FigureAuxCloseAction(h_Object,~)
        ...
        switch h_Object
            case st_MontageElec.CancelButton
                % If the callback is from the cancel control of auxiliary
                % figure: Select Channels 
                h_Object    = st_hFigure.MontageElec;
                
            case st_SelElect.CancelButton
                % If the callback is from the cancel control of auxiliary
                % figure: Select Channels 
                h_Object    = st_hFigure.SelElec;
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_MontageSelect(~,~)
        % View and hide channel assemby controls
        
        switch get(st_MontageElec.Montage,'Value')
            case 1
                set(st_MontageElec.ListElec2,'Visible','off')
            case 2
                set(st_MontageElec.ListElec2,'Visible','on')
            case 3
                f_MontageLoad()
        end
    end
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_MontageOK(~,~)
        ...
        if ~isfield(st_FileInfo,'v_Labels')            
            f_FigureAuxCloseAction(st_hFigure.MontageElec);
            return
        end
        if ismember('',st_FileInfo.v_Labels)            
            v_NumChanStr = cellstr(strcat(repmat('chan',numel(st_FileInfo.s_Samples),1),num2str((1:numel(st_FileInfo.s_Samples))')));
            st_FileInfo.v_Labels = v_NumChanStr;         
        end
        
        st_Montage  = f_MontageBuild();
        
        st_ElecInfo.str_CommonElec(end+1)	= st_Montage.str_MontageName;
        st_ElecInfo.str_CommMont(end+1)     = {[st_Montage.str_Ch1Montag ...
                                            st_Montage.str_Ch2Montag]};
        st_FileInfo.v_SampleRate(end+1)     = st_FileInfo.v_SampleRate(...
                                            get(st_MontageElec.SelElec1,...
                                            'Value'));
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_MontageLoad()
        ...
        set(st_MontageElec.Montage,'Value',st_Montage.s_Type)
        switch get(st_MontageElec.Montage,'Value')
            case 1
                v_Idx   = find(ismember(get(st_MontageElec.SelElec2,'String'),...
                        st_Montage.str_Ch2Montag{1,1}));
                set(st_MontageElec.SelElec2,'Value',v_Idx)
            case 2
                v_Idx   = find(ismember(get(st_MontageElec.ListElec2,'String'),...
                        st_Montage.str_Ch2Montag{1,1}));
                set(st_MontageElec.ListElec2,'Value',v_Idx)
            otherwise
        end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function st_Montage = f_MontageBuild()
        ...
        str_Ch1Montag   = get(st_MontageElec.SelElec1,'String');
        str_Ch1Montag   = str_Ch1Montag(get(st_MontageElec.SelElec1,...
                                'Value'));
                
        switch get(st_MontageElec.Montage,'Value')
            case 1
                str_Ch2Montag   = get(st_MontageElec.SelElec2,'String');
                str_Ch2Montag   = str_Ch2Montag(get(st_MontageElec.SelElec2,...
                                'Value'));
            ...
            case 2
                str_Ch2Montag   = get(st_MontageElec.ListElec2,'String');
                str_Ch2Montag   = {str_Ch2Montag(get(st_MontageElec.ListElec2,...
                                'Value'))};
        ...
        st_Montage.s_Type           = get(st_MontageElec.Montage,'Value');
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    % Read signal header for analysis   
        ...
        if isempty(st_FilePath.name)
            ...
            set(st_SelElect.FileList,'String',st_FilePath.full)
        end
        
        m_CellStr               = cell(1,numel(st_FilePath.path));
        
        st_ElecInfo.st_FileInfo = cell(size(st_FilePath.name));
        ...
        for kk=1:numel(st_FilePath.name)
            ...
            st_FileInfo.s_Time	= str2double(...
                                mat2str(st_FileInfo.s_Time));
            
            st_ElecInfo.st_FileInfo(kk)	= {st_FileInfo};
        ...
        st_ElecInfo.str_CommonElec    = v_CommonCh(m_CommonTable == ...
                                    numel(st_FilePath.name));
                                
        if numel(m_CommonTable) ~= numel(st_ElecInfo.str_CommonElec)
            warndlg(['There are electrodes not common' ...
                    ', these electrodes will be ignored'],'!! Warning !!');
        end
                
        st_ElecInfo.str_CommMont = st_ElecInfo.str_CommonElec;
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_MontageAdd(~,~)
        set(st_hFigure.MontageElec,'Visible','on')
    end    
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_InfoElecAdd(~,~)
        % Add a channel to read or load
        
        v_ListIdx   = get(st_SelElect.ElecList,'Value');
        ...
        for kk=1:numel(v_ListIdx)
            ...
            s_TotalTime(kk,1)   = {st_FileInfo.s_Time}; 
            s_Sampling(kk,1)    = {st_FileInfo.v_SampleRate(v_ListIdx(kk))};
        end
        
        if  isempty(st_ElecInfo.str_ElecName)
            st_ElecInfo.str_ElecName    = st_ElecInfo.str_CommonElec(v_ListIdx);
        else
            st_ElecInfo.str_ElecName	= vertcat(st_ElecInfo.str_ElecName,...
                                        st_ElecInfo.str_CommonElec(v_ListIdx));
        end
        
        if isempty(st_ElecInfo.str_Montage)
            st_ElecInfo.str_Montage     = st_ElecInfo.str_CommMont(v_ListIdx);
        else
            st_ElecInfo.str_Montage     = vertcat(st_ElecInfo.str_Montage,...
                                        st_ElecInfo.str_CommMont(v_ListIdx));
        end
               
        if isempty(st_ElecInfo.s_Sampling)
            st_ElecInfo.s_Sampling	= s_Sampling; 
        else
            st_ElecInfo.s_Sampling	= vertcat(st_ElecInfo.s_Sampling,...
                                    s_Sampling);
        end
        
        if isempty(st_ElecInfo.s_TotalTime)
            st_ElecInfo.s_TotalTime	= s_TotalTime;
        
        else                                        
            st_ElecInfo.s_TotalTime	= vertcat(st_ElecInfo.s_TotalTime,...
                                    s_TotalTime);
        end
        if ismember('',st_FileInfo.v_Labels)            
            v_NumChanStr = cellstr(strcat(repmat(...
        ...
        [~, v_Idx]   = unique(st_ElecInfo.str_ElecName);
        
        v_Idx                     = sort(v_Idx,'ascend');
        st_ElecInfo.str_ElecName  = st_ElecInfo.str_ElecName(v_Idx); 
        st_ElecInfo.s_Sampling    = st_ElecInfo.s_Sampling(v_Idx);
        st_ElecInfo.str_Montage   = st_ElecInfo.str_Montage(v_Idx);
        st_ElecInfo.s_TotalTime   = st_ElecInfo.s_TotalTime(v_Idx);
        
        f_InfoWriteTable()
                
    end  
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_InfoElecRemove(~,~)
        % Remove a channel to read or load
        
        v_RowSelected   = get(st_SelElect.InfoTable,'UserData');
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_InfoElecUp(~,~)
        ...
        st_ElecInfo.str_ElecName([v_RowSelected - 1, v_RowSelected])      = ...
            st_ElecInfo.str_ElecName([v_RowSelected, v_RowSelected - 1]);
        
        st_ElecInfo.s_Sampling([v_RowSelected - 1, v_RowSelected])    = ...
            st_ElecInfo.s_Sampling([v_RowSelected, v_RowSelected - 1]);
                
        st_ElecInfo.s_TotalTime([v_RowSelected - 1, v_RowSelected])   = ...
            st_ElecInfo.s_TotalTime([v_RowSelected, v_RowSelected - 1]) ;
                
        st_ElecInfo.str_Montage([v_RowSelected - 1, v_RowSelected])   = ...
            st_ElecInfo.str_Montage([v_RowSelected, v_RowSelected - 1]) ;
        
        f_InfoWriteTable()
         
    end  
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_InfoElecDown(~,~)
        ...
        if v_RowSelected == numel(st_ElecInfo.str_ElecName)
            return
        end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_InfoClear(~,~)
        ...
        st_ElecInfo.str_ElecName    = [];
        st_ElecInfo.s_Sampling      = [];      
        st_ElecInfo.s_TotalTime     = [];
        st_ElecInfo.str_Montage     = [];
        st_ElecInfo.str_CommonElec  = [];
        st_ElecInfo.str_CommMont	= []; 
        st_ElecInfo.str_MtgeLoad    = [];
        ...
        set(st_SelElect.FileList,'String',st_FilePath.nativepath,'Value',1)        
        set(st_SelElect.InfoTable,'Data',[])
              
        f_PlaceSelChanInfo()
        f_DataClear('all')  
    end 
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_ElectrodeApply(~,~)
        %Memorize the electrodes selected
        ...
        [st_Data.v_TimeLims, s_Check]    = f_CheckTextNumbers(...
                                        get(st_SelElect.TimeTxtIni,'string'),...
                                        get(st_SelElect.TimeTxtEnd,'string'),...
                                        st_FileInfo.s_Time);    
                                
        if s_Check == -1
            uicontrol(st_SelElect.TimeTxtIni)
            st_ElecInfo.FlagError  = true;
            return
        elseif s_Check == -2 || numel(st_Data.v_TimeLims) == 1
            uicontrol(st_SelElect.TimeTxtEnd)
            st_Data.v_TimeLims(2)   = st_FileInfo.s_Time;
            st_ElecInfo.FlagError  = true;
            return
        end
                
        st_Data.v_Labels    = st_ElecInfo.str_ElecName;
        ...
        f_FigureAuxCloseAction(st_SelElect.CancelButton)
        pause(0.5)
        
    end 
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_ElectrodeDisplay(~,~)
        %Load and Print the electrodes selected
        
        st_ElecInfo.str_ElecLoad  = st_ElecInfo.str_ElecName;
        st_ElecInfo.str_MtgeLoad  = st_ElecInfo.str_Montage;
       
        f_InfoReadTable()
        f_ElectrodeLoad()
        
        %Check if there is a error
        if st_ElecInfo.FlagError
            return
        end
        ...
        st_Position.s_NumElecSel    = numel(st_Data.v_Labels);
        st_Offset.Vector            = st_Offset.Value * ...
                                               (st_Position.s_NumElecSel:-1:1)';
        st_Position.s_TimeIni       = st_Data.v_Time(1);
        
        % Set number of electrodes available

        set(st_Select.ElecList,...
            'String',num2str((1:st_Position.s_NumElecSel)'),...
            'Value',st_Position.s_NumElecSel)
        ...
        st_Position.v_VerticalPos   = [1;st_Position.s_NumElecSel];
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_ElectrodeLoad(~,~)
        %Load the electrodes selected        
        ...
        st_ElecInfo.st_FileIdxLoad      = get(st_SelElect.FileList,'Value');
        st_FileInfo                     = st_ElecInfo.st_FileInfo{...
                                        st_ElecInfo.st_FileIdxLoad};
        ...
        m_Data  = cell(1,numel(st_ElecInfo.str_ElecLoad));    
        s_ticID = tic;
        
        for kk = 1:numel(st_ElecInfo.str_ElecLoad)
            
            str_ChLoad  = st_ElecInfo.str_MtgeLoad{kk,:};
            
            if ~iscell(str_ChLoad)
                s_ChNumel   = 1;
            else
                s_ChNumel   = numel(str_ChLoad);
            end
            ...
            switch s_ChNumel 
                case 1
                    ...
                    if iscell(st_FileInfo.v_Labels)
                        [~,v_ChIdx] = ismember(str_ChLoad,...
                                                    st_FileInfo.v_Labels);
                    else
                        v_ChIdx     = 1;
                    end
                         
                    v_DataTmp       = f_GetData(st_FileInfo,...
                                    st_Data.v_TimeLims,v_ChIdx);
                                              
                    m_Data{kk}      = v_DataTmp.m_Data(:);
                    
                case 2
                    
                    str_Channels    = vertcat(str_ChLoad{1},str_ChLoad{2});
                    
                    [~,v_ChIdx]     = ismember(str_Channels,...
                                                    st_FileInfo.v_Labels);
                                    
                    v_DataTmp       = f_GetData(st_FileInfo,...
                                    st_Data.v_TimeLims,v_ChIdx);

                    m_Data{kk}      = v_DataTmp.m_Data(:,1) -  ...
                                    mean(v_DataTmp.m_Data(:,2:end),2);      
            ...
            v_DataTmp = rmfield(v_DataTmp, [{'m_Data'},{'v_Labels'}]);
            waitbar(kk / numel(st_ElecInfo.str_ElecLoad))
        end
        ...
        st_Data.m_Data      = cell2mat(m_Data);
        st_Data.v_Time      = v_DataTmp.v_Time;
        st_Data.v_Labels    = st_ElecInfo.str_ElecLoad;
        st_Data.s_Sampling  = v_DataTmp.s_Sampling;
        st_Data.s_TotalTime = str2double(num2str(v_DataTmp.s_TotalTime));
        st_Data.v_TimeLims  = v_DataTmp.v_TimeLims;
        st_Data.v_TimeStart = f_Secs2hms(f_HMS2Secs(st_FileInfo.s_Start)+...
                            f_HMS2Secs([0 st_Data.v_TimeLims(1) 0]));
        
        % Save Original Data
        m_Data          = cell2mat(m_Data); %#ok<NASGU>
        str_TmpFName	= st_FilePath.name{st_ElecInfo.st_FileIdxLoad};
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_HFORunAnalysis(~,~)
        ...
        st_HFOControl.v_ElectrodeIdx     = ...
                                        get(st_HFOMethod.ElectrodeList,'Value');
                   
        if sum(st_HFOControl.v_ElectrodeIdx) == 0
            return
        end
        
        if get(st_HFOMethod.MethodList,'Value') == 1                            
            if isempty(st_hAxes.Main)
                warndlg('Display electrodes is required','Warning')                
                f_FigureAuxCloseAction(st_HFOMethod.CancelButton)
                return
            end
                                      
            if numel(st_HFOControl.v_ElectrodeIdx) ~= 1
                warndlg('Please select only one electrode','Warning')
                uicontrol(st_HFOMethod.ElectrodeList)
                return
            end            
...
%:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_RunSingleFileAnalysis()
        ...
        f_HFOCreateSaveFile(get(st_SelElect.FileList,'Value'))
        ...
        if ~isfield(st_HFOData.v_ElecHFOInfo{...
        ...
        if ~isempty(st_hLines.MainLines)
            for kk = 1:numel(st_HFOData.v_ElecHFOInfo)
...
%:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_RunMultiFileAnalysis()
        ...
        s_IsMulFileHFO      = 1;
        st_Data.s_Sampling  = st_ElecInfo.st_FileInfo{...
                              get(st_SelElect.FileList,'Value')...
                              }.v_SampleRate(1);
        ...
        switch get(st_HFOMethod.MethodList,'Value')
                case 1 || 2
                    [v_Values, s_Check]      = f_CheckTextNumbers('0',...
                        get(st_HFOMethod.EpoTimTxt,'string'),...
                        st_Data.s_TotalTime);
                    
                    if s_Check == -2
                        uicontrol(st_HFOMethod.EpoTimTxt)
                        return
                    end
                    
                case 3
                    [v_Values, s_Check]      = f_CheckTextNumbers('0',...
                        get(st_HFOMethod.EpoTFTTxt,'string'),...
                        st_Data.s_TotalTime);
                    
                    if s_Check == -2
                        uicontrol(st_HFOMethod.EpoTFTTxt)
                        return
                    end
        end
        ...
        pause(0.001)
%         v_ChIdx         = st_HFOControl.v_ElectrodeIdx;
              
        st_HFOControl.str_ChLoad    = st_ElecInfo.str_ElecName(...
                                            st_HFOControl.v_ElectrodeIdx);
                                        
        for kk = 1:numel(st_FilePath.name)
                        
            set(st_SelElect.FileList,'Value',kk)
            ...
            for jj = 1:numel(st_HFOControl.str_ChLoad)
                ...
                st_HFOControl.v_ElectrodeIdx = 1;
                st_ElecInfo.str_ElecLoad      = st_HFOControl.str_ChLoad(jj);
                st_ElecInfo.str_MtgeLoad      = st_ElecInfo.str_Montage(jj);
                ...
                s_Percentage 	= (jj-1)/...
                                        numel(st_ElecInfo.str_ElecName);
                                    
                p_HFOWaitFigure(st_WaitOutput,...
                        'ChanString',st_ElecInfo.str_ElecLoad)
                p_HFOWaitFigure(st_WaitOutput,...
...
%:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	function f_HFORunVisualMarking()
        ...
        st_HFOSettings.s_FreqIni    = v_Values(1);
        st_HFOSettings.s_FreqEnd    = v_Values(2);
        st_HFOControl.s_CurrElecIdx = st_HFOControl.v_ElectrodeIdx;
        ...
        set(st_VisualMark.Electrode,...
            'String',st_ElecInfo.str_ElecLoad(st_HFOControl.s_CurrElecIdx))
        set(st_TimeFreq.ElecList,'Value',st_HFOControl.s_CurrElecIdx)
        ...
        st_HFOData.str_ElectLabels  = st_Data.v_Labels(...
                                        st_HFOControl.v_ElectrodeIdx);                        
        st_HFOData.v_ElecHFOInfo    = cell(numel(...
                                        st_HFOControl.v_ElectrodeIdx),1);
...
%:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
	function f_HFORunMethod() %  Insert here Selection Options[**INSERT!**]
        ...
        for kk = 1:numel(st_HFOControl.v_ElectrodeIdx)
                                        
            st_HFOControl.s_CurrElecIdx = st_HFOControl.v_ElectrodeIdx(kk);
            st_HFOControl.s_IdxCycle    = kk;
            st_HFOAnalysis.str_ChLabel  = st_Data.v_Labels(...
                                            st_HFOControl.s_CurrElecIdx);
            st_HFOAnalysis.s_Sampling   = st_FileInfo.v_SampleRate(...
            ...
            if ~s_IsMulFileHFO
                s_Percentage 	= (kk-1)/...
                                        numel(st_HFOControl.v_ElectrodeIdx);
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_SaveInterval (h_Object,~)
        ...
        str_FileName    = sprintf('%s-Interval-Start_%ih-%im-%0.2gsec',str_Name,...
                        v_Event(1),v_Event(2),v_Event(3));
        ...
        Header.IniTime	= st_Data.v_TimeStart;
    ...
    function f_FigureClose(~,~)
        ...
        switch str_CloseSel, 
            case 'Yes',
                ...
                delete(st_hFigure.MontageElec)
                delete(st_hFigure.SelElec)
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_FigureAuxShowHiden(hObject,~)
        ...
        switch hObject
            case st_hIcons.open
                set(st_hFigure.SelElec,'Visible','on')
    ...
    function f_FilterNotch(hObject,~)
        ...
        switch get(hObject,'Value')
            ...
            case 2
                ...
                % s_Filter = f_GetIIRFilter(st_Data.s_Sampling,[49 51],[],...
                %                                         'stop',[100 100]);
            case 3
                st_HandleMsg            = f_waitmsg('Filtering Signal');
                pause(1)
                ...
                v_NotchFreqs    = 60;
                % s_Filter = f_GetIIRFilter(st_Data.s_Sampling,[59 61],[],...
                %                                        'stop',[100 100]);
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_FilterProcess(~,~)
        ...
        % Check filter mode (all electrodes or one electrode)        
        if logical(get(st_Filter.AllChk ,'Value'))
            ...
            s_Counter       = 0;                
            h_wBar          = waitbar(0,'Please wait, Filtering Electrodes...');
                        
            if ~isfield(st_FilterData,'v_NewElecIdx')
                st_FilterData.v_NewElecIdx	= false;
                st_FilterData.v_ElecIdx     = [];
                st_FilterData.v_FiltCutFr   = [];                
            end
            
            if st_FilterData.v_NewElecIdx == 0
                st_FilterData.v_NewElecIdx = 1;
            end
            ...
            for kk = st_FilterData.v_NewElecIdx
                
                st_FilterData.v_ElecIdx(end+1)	= kk;
                switch s_FilType
                    case -1
                        st_FilterData.v_FiltCutFr{end+1,1}= strcat('[<',mat2str(v_FreqsCut),']');
                    case 1
                        st_FilterData.v_FiltCutFr{end+1,1}= strcat('[>',mat2str(v_FreqsCut),']');
                    otherwise
                ...
                if s_isIIR
                    st_FilterData.m_ElecFilter(:,end+1) = f_FilterIIR(...
                                                        st_Data.m_Data(:,kk),...
                                                        s_Filter);
                else
                    st_FilterData.m_ElecFilter(:,end+1) = fd_filtfilt(s_Filter,1,...
                                                        st_Data.m_Data(:,kk));
                end
                
                waitbar(s_Counter + 1 / numel(st_FilterData.v_NewElecIdx))
            end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_FilterBuildLines()
        ...
        v_OffsetFilter  = (1:numel(st_FilterData.v_ElecIdx)).*st_Offset.Value;       
        ...
        set(st_hAxes.Filter,...
            ...
            'YTickLabel',cellfun(@strcat,...
                        st_Data.v_Labels(st_FilterData.v_ElecIdx),...
                        repmat({'_'},...
                        size(st_Data.v_Labels(st_FilterData.v_ElecIdx))),...
                        st_FilterData.v_FiltCutFr,...
                        repmat({'Hz'},...
                        size(st_Data.v_Labels(st_FilterData.v_ElecIdx))),...
                        'UniformOutput',false),...
...
%         end
        ...
        % Plot Filter Lines
        st_hLines.FiltLines  = - ones(numel(st_FilterData.v_ElecIdx),1);
        for kk=1:numel(st_FilterData.v_ElecIdx)
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_FilterAddElect(~,~)
        ...
        [v_Idx,s_Selection]   = listdlg(...
                ...
                'SelectionMode','multiple',...
                'PromptString','Select Electrodes:',...
                'Name','Add Filter',...
                'OKString','Add');
        ...
        st_FilterData.v_NewElecIdx  = v_Idx;
                                    
        % If it is already filtered doesn't do anything
        if ismember(st_FilterData.v_NewElecIdx ,st_FilterData.v_ElecIdx)
            
            v_Idx   = find(...
                    st_FilterData.v_ElecIdx == st_FilterData.v_NewElecIdx );
            
            st_FilterData.v_ElecIdx(:,v_Idx)    = [];
            st_FilterData.m_ElecFilter(:,v_Idx) = [];
        end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_FilterRemoveElectrode(~,~) 
        %Remove unique electrodes in filter panel
        ...
        if isempty(st_FilterData.v_ElecIdx)
            st_FilterData.s_Exists      = false;
            st_FilterData.m_ElecFilter  = [];
        end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_TimeFreqSetOptions(~,~)
        ...
        [st_SpectrumOpt.s_TimeFreqScale, s_Check]  = f_CheckTextNumbers(...
                              '-1e-10',get(st_TimeFreq.Scale ,'string'),1);
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_TimeFreqProcess(~,~)
        ...
        str_CloseOK = questdlg(...
            ['Depending on the time displayed and the frequency resolution, the scalogram '...
            'computing can take more some minutes. If you want to reduce the processing time, '...
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_TimeFreqSetDisplay()
        ...
        st_Spectrum.st_FilterData.v_NewElecIdx  = get(st_TimeFreq.ElecList,'Value');
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_TimeFreqSetSpectrum()
        % Set Scalogram
        s_miTimexPlot   = 0.25;
        if ~logical(get(st_Select.TimFrqPanel,'Value')) || any(isnan(st_Spectrum.v_FreqLims))
            return
        end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_CursorSelectElec(~,~)
        % Get electrode for cursors
        if ~isfield(st_Data,'m_Data')
            return
        end
        
        st_Cursors.s_ElecCursor = get(st_SegmAnalys.ElecList,'Value');
        set(st_PSDCursor.Label,...
            'String',st_Data.v_Labels(st_Cursors.s_ElecCursor))
        f_DisplayProcess()
...
%                                 st_Cursors.s_ElecCursor),...
%                                 st_Data.s_Sampling,...
%                                 st_Data.v_Labels{st_Cursors.s_ElecCursor})
            end
        else
    ...
    function f_LinesUpDown(hObject,~)
        ...
        switch hObject
            case st_hPanelObj.LinesBdown
                ...
                if st_Position.v_VerticalPos(1) + ...
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_PlaceSelChanInfo()
        ...
        switch st_FileInfo.str_FileType
            case {'data','eeg','numeric','ncs','mat'}
                s_MustReadAll   = false;
            case {'rec','edf'}
                s_MustReadAll   = false;
            otherwise
        ...
        if s_MustReadAll
            % Place Ini Time
            set(st_SelElect.TimeTxtIni,...
                'String','0',...
                'Enable','off')
            % Place End Time
            set(st_SelElect.TimeTxtEnd,...
                'String','Inf',...
                'Enable','off')
        else
            % Place Ini Time
        ...
        % Place Signal Label 
        set(st_SelElect.ElecList,...
            'Value',[],...
            'String',st_ElecInfo.str_CommonElec)
        
        set(st_MontageElec.SelElec1,...
            'String',st_ElecInfo.str_CommonElec)
        
        set(st_MontageElec.SelElec2,...
            'String',st_ElecInfo.str_CommonElec)
        
        set(st_MontageElec.ListElec2,...
            'String',st_ElecInfo.str_CommonElec)
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_PlaceAuxControlData()
        ...
        set(st_TimeFreq.ElecList,...
            'String',st_Data.v_Labels,...
            'Value',1)
        
        set(st_SegmAnalys.ElecList,...
            'String',st_Data.v_Labels,...
            'Value',1)
        
        set(st_HFOMethod.ElectrodeList,...
            'String',st_Data.v_Labels,...
            'Value',1)
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_InfoWriteTable()
        ...
        m_Data      = cell(numel(st_ElecInfo.str_ElecName),4);
        
        m_Data(:,1) = st_ElecInfo.str_ElecName;
        m_Data(:,2) = st_ElecInfo.s_Sampling;
        m_Data(:,3) = st_ElecInfo.s_TotalTime;
%         m_Data(:,4) = st_ElecInfo.str_Montage;
        
        set(st_SelElect.InfoTable,'Data',m_Data)
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_InfoReadTable()
        ...
        m_Data      = get(st_SelElect.InfoTable,'Data');
        
        if isempty(m_Data)
            warndlg('Please insert an electrode to the selected electrodes table',...
                'RippleLab Warning!')
            return
        end
        st_ElecInfo.str_ElecName    = m_Data(:,1);
        st_ElecInfo.s_Sampling      = m_Data(:,2);
        st_ElecInfo.s_TotalTime     = m_Data(:,3);
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_HFOSet_MNI()
        ...
        if s_Check == -2
            uicontrol(st_HFOMethod.MNI_EpoTimLab)
            return
        end
...
%Subfunctions for HFO visualization
    function f_HFOSetElecInfo()
        % Set Channel Info Cell
        
        st_HFOAnalysis.s_ChIdx          = st_HFOControl.s_CurrElecIdx;
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_HFOCreateSaveFile(ps_FileIdx)
        ...
        st_FileData     = st_ElecInfo.st_FileInfo{ps_FileIdx}; %#ok<NASGU>
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_HFOBuildCluster()
        ...
        if isempty(st_HFOData.v_ElecHFOInfo{st_HFOControl.s_IdxCycle})
            return
        end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_LineSetHFOSegments()
        ...
        st_HFOControl.v_hLines     = [];
        st_HFOControl.m_EvtLimDisp = cell(size(st_HFOData.v_ElecHFOInfo));
        
        for kk = 1:numel(st_HFOData.v_ElecHFOInfo)
            
            if isempty(st_HFOData.v_ElecHFOInfo{kk})
                st_HFOControl.m_EvtLimDisp{kk}   = [];
                continue
            end
            if isempty(st_HFOData.v_ElecHFOInfo{kk}.m_EvtLims)
                st_HFOControl.m_EvtLimDisp{kk}   = [];
                continue
            end

            v_VisLineIdx 	= sum(...
                            st_HFOData.v_ElecHFOInfo{kk}.m_EvtLims >= ...
                            st_Position.s_IdxIni & ...
                            st_HFOData.v_ElecHFOInfo{kk}.m_EvtLims <= ...
            ...
            if isempty(v_VisLineIdx)
                ...
                st_HFOControl.m_EvtLimDisp{kk}= st_HFOData.v_ElecHFOInfo{...
                                                kk}.m_EvtLims(...
                                                v_VisLineIdx,:);  
            end
        end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_LinesBuildHFOSegments(s_sStep,s_SubSample,s_Scale)
        ...
        st_HFOControl.v_hLines = cell(size(st_HFOData.v_ElecHFOInfo));
        for ii = 1:numel(st_HFOData.v_ElecHFOInfo)
            ...
            for kk = 1:numel(st_Offset.SelectedLab)
                if strcmp(cell2mat(st_Offset.SelectedLab(kk)),...
                        cell2mat(st_HFOData.v_ElecHFOInfo{ii}.str_ChLabel))
                    s_SigHFOIdx     = kk;
                    break
                end
                s_SigHFOIdx     = [];
            ...
            for kk=1:size(st_HFOControl.m_EvtLimDisp{ii},1)
                ...
                v_Ind       = v_Ind(v_Ind<numel(st_Data.m_Data(:,...
                            st_HFOData.v_ElecHFOInfo{ii}.s_ChIdx)));
                v_SigDisp   = st_Data.m_Data(...
                                v_Ind,st_HFOData.v_ElecHFOInfo{ii}.s_ChIdx);
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    function f_HFOSaveElec()
        % Save channel HFO Info
        
        
        
        if isempty(st_HFOData.v_ElecHFOInfo{...
                st_HFOControl.s_IdxCycle}.m_EvtLims)
            return
        end
                
        st_Ch.st_HFOSetting = st_HFOSettings;
        st_Ch.st_HFOInfo    = st_HFOData.v_ElecHFOInfo{...
                            st_HFOControl.s_IdxCycle};
